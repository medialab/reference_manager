...
def formatted_name(contributor, style=metajson.STYLE_FAMILY_COMMA_GIVEN):
    if "person" in contributor:
        return contributor["person"].formatted_name(style)
    elif "orgunit" in contributor:
        return contributor["orgunit"].formatted_name()
    elif "event" in contributor:
        return contributor["event"].formatted_name()
    elif "family" in contributor:
        return contributor["family"].formatted_name()
