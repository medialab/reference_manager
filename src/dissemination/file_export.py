...
from metadatas.metajson import Common, Collection, Document, Contributor, Identifier, Resource
...
def export_metajson(document_list, output_file_name):
    with open(output_file_name, "w") as metajson_file :
        ...
        metajson_file.write(bson.json_util.dumps(collection, ensure_ascii=False, indent=4, encoding="utf-8", sort_keys=True))